...
$(function () {
  ...
  $("#calc-button").click(clickedPowerLevelCalculator)
...
//This is where I create the function to add the pet's weight and happiness to get the pet's powerlevel.
function clickedPowerLevelCalculator() {
  ...
  // This is the piece of code that makes the calculator have a bug. 
  //var sum_result = num1 + num2;

  //This is the corrected code to have a correct addition result.
  var sum_result = parseInt(num1) + parseInt(num2);

  //show the result
  $("#calc-result").text(sum_result);
}
